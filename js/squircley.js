...
function createSquircle(opts) {
  ...
  const path = createSquirclePath(opts.width, opts.height, opts.viewBox[2], opts.viewBox[3], opts.curvature, opts.rotate);

  const squircleSVG = createSquircleSVG(opts.viewBox[2], opts.viewBox[3], path);
